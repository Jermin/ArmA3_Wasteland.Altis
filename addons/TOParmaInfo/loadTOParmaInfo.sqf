...
_serverInfoString = format ["<t color='#1AD4FF'>ESPC Wasteland</t>"];
...
_generalInfoString = "Forums: <t color='#0091CD'><a href='http://arma.espc.asia'>ESPC Wasteland Forum</a></t>  QQ: 121120633  YY: 61489275";
