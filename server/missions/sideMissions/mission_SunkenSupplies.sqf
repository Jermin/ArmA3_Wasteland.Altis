...
_setupObjects =
{
	...
	_randomBox = ["mission_USLaunchers","General_supplies","airdrop_Snipers"] call BIS_fnc_selectRandom;
	_randomBox2 = ["mission_USSpecial","mission_Main_A3snipers","airdrop_Launchers"] call BIS_fnc_selectRandom;
