...
switch (_boxType) do
{
	case "mission_USLaunchers":
	{
		...
		[
			...
			["mag", ["ClaymoreDirectionalMine_Remote_Mag", "SLAMDirectionalMine_Wire_Mag", "ATMine_Range_Mag", "DemoCharge_Remote_Mag", "SatchelCharge_Remote_Mag", "MiniGrenade", "SmokeShell"], RANDOM_BETWEEN(3,8)]
		];
	};
